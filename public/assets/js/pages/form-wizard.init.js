    ...
    Array.from(document.querySelectorAll(".form-steps")).forEach(function (l) {
        l.querySelectorAll(".nexttab") &&
            Array.from(l.querySelectorAll(".nexttab")).forEach(function (t) {
                ...
                // Remove validation check and just move to the next tab
                t.addEventListener("click", function () {
                    var nextTabId = t.getAttribute("data-nexttab");
        ...
        l.querySelectorAll(".previestab") &&
            Array.from(l.querySelectorAll(".previestab")).forEach(function (o) {
                o.addEventListener("click", function () {
                    var e = o.getAttribute("data-previous");
                    var t = o.closest("form").querySelectorAll(".custom-nav .done").length;

                    // Remove 'done' class for previous steps
                    for (var r = t - 1; r < t; r++) {
                        var doneSteps = o.closest("form").querySelectorAll(".custom-nav .done");
                        doneSteps[r] && doneSteps[r].classList.remove("done");
                    }
                ...
                r.setAttribute("data-position", o),
                    r.addEventListener("click", function () {
                        ...
                        if (r.getAttribute("data-progressbar")) {
                            var totalSteps = document.getElementById("custom-progress-bar").querySelectorAll("li").length - 1;
                            e = (o / totalSteps) * 100;
