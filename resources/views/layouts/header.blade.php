...
<html lang="en" data-layout="vertical" data-topbar="light" data-sidebar="dark" data-sidebar-size="lg"
    data-sidebar-image="none" data-theme="galaxy" data-bs-theme="light" data-layout-position="fixed"
    data-theme-colors="default" data-preloader="enable">

<head>

    <meta charset="utf-8" />
    <title>Dashboard | Housing</title>
    ...
    <link href="{{ asset('public/assets/libs/jsvectormap/css/jsvectormap.min.css') }}" rel="stylesheet"
        type="text/css" />
    <!-- toaster css -->
    <script src="{{ asset('/public/assets/js/toastr/toastr.min.css') }}"></script>
    <!--Swiper slider css-->
                    ...
                    <div class="d-flex align-items-center">
                                    ...
                                    <div class="tab-pane fade p-4" id="alerts-tab" role="tabpanel"
                                        ...
                                        <div class="empty-notification-elem">
                                            <div class="w-25 w-sm-50 pt-3 mx-auto"> <img
                                                    src="assets/images/svg/bell.svg" class="img-fluid"
                                                    alt="user-pic"> </div>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                {{-- <a class="dropdown-item" href="{{ config('app.basePath') . '/settings' }}"><span
