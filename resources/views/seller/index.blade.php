    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="modal fade" id="seller-add-edit" tabindex="-1" aria-labelledby="Seller-add-label" aria-modal="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="seller-add-label">Add Seller</h5>
                ...
                <div class="modal fade" id="Seller-view" tabindex="-1" aria-labelledby="-view-label" aria-modal="true">
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="Seller-view-label">Add Seller </h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            ...
                            <div class="page-title-right">
                                <button type="button" data-bs-toggle="modal" data-bs-target="#Seller-add"
                                ...
                                <table id="example"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th data-ordering="false">Seller</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="link-success fs-3 me-2"
                                                    data-bs-toggle="modal" data-bs-target="#seller-add-edit"
